...
try {
    ...
    if ($result && $result->num_rows > 0) {
        ...
        // Check if voting is actually active based on dates AND is_active flag
        ...
        // If dates don't have time, add default times
        if (strlen($start) == 10)
            $start .= ' 00:00:00';
        if (strlen($end) == 10)
            $end .= ' 23:59:59';
        ...
        // Add this calculated field to the response
